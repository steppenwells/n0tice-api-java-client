...
public class N0ticeApi {
	...
	public List<ModerationComplaint> getModerationComplains(String id) throws AuthorisationException, BadRequestException, NotAllowedException, N0ticeException {
